...
public class SyncUtils {
    ...
    public static final String ACCOUNT_TYPE = "hanthong.me";
    private static final long SYNC_FREQUENCY = 60 * 60;  // 1 hour (in seconds)
    private static final String CONTENT_AUTHORITY = NewsProvider.AUTHORITY;
    ...
    public static void TriggerRefresh() {
        ...
        ContentResolver.requestSync(
                ...
                NewsProvider.AUTHORITY,                 // Content authority
                b);                                             // Extras
    }
}
